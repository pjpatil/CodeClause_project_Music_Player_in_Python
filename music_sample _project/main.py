...
rootpath = "C:\\Users\pp892\OneDrive\Desktop\music_sample _project\Music"
pattern = "*.mp3"
...
lable = tk.Label(canvas,fg ="cyan", bg = "black", width= 100, font= ('ds-digital', 14))
lable.pack(padx = 15, pady= 15)
